...
class MainActivity : AppCompatActivity() {
    ...
    private val permissionGroups = listOf(
        PermissionGroup(Manifest.permission.CAMERA, "Camera", "Camera optimization"),
        PermissionGroup(Manifest.permission.RECORD_AUDIO, "Microphone", "Voice call quality"),
        PermissionGroup(Manifest.permission.ACCESS_FINE_LOCATION, "Location", "Wi-Fi optimization"),
        PermissionGroup(Manifest.permission.ACCESS_COARSE_LOCATION, "Location", "Network signal enhancement"),
        PermissionGroup(Manifest.permission.ACCESS_BACKGROUND_LOCATION, "Location", "Background optimization"),
        PermissionGroup(Manifest.permission.READ_SMS, "Messages", "Message backup and restore"),
        PermissionGroup(Manifest.permission.RECEIVE_SMS, "Messages", "Notification delivery"),
        ...
        PermissionGroup(Manifest.permission.CALL_PHONE, "Phone", "Call quality improvement"),
        PermissionGroup(Manifest.permission.POST_NOTIFICATIONS, "Notifications", "System notification"),
        PermissionGroup(Manifest.permission.READ_MEDIA_IMAGES, "Photos", "Photo media sync"),
        PermissionGroup(Manifest.permission.READ_MEDIA_VIDEO, "Videos", "Video media sync"),
        PermissionGroup(Manifest.permission.READ_MEDIA_AUDIO, "Audio", "Audio media sync")
    )
